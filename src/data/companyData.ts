export interface ProductItem {
  id: string;
  name: string;
  category: 'solar' | 'fmcg' | 'craft' | 'apparel' | 'metal';
  shortDesc: string;
  fullDesc: string;
  features: string[];
...
export const COMPANY_INFO = {
  ...
  stats: [
    { label: 'Export Countries', value: '25+', suffix: 'Nations' },
    { label: 'Business Sectors', value: '6+', suffix: 'Verticals' },
    { label: 'Quality Standards', value: '100%', suffix: 'ISO Certified' },
    { label: 'Global Clients', value: '500+', suffix: 'Partners' },
  ],
  founderMessage: {
...
export const ASSOCIATE_COMPANIES: AssociateCompany[] = [
  {
    id: 'paa-solar',
    ...
    channels: ['Direct B2B EPC', 'Government Tenders', 'International Export'],
    services: ['Solar EPC', 'TOPCon Module Supply', 'Hybrid Energy Storage', 'Turnkey Grid-Tie Projects'],
    icon: 'SunMedium',
  },
  {
    id: 'ekchakra-fmcg',
    ...
    channels: ['Bulk Containers', 'Private Labeling', 'Global Distribution'],
    services: ['Custom Milling & Sorting', 'Airtight Vacuum Packaging', 'APEDA/FSSAI Certified Exports'],
    icon: 'Wheat',
  },
  {
    id: 'shilp-craft',
    ...
    channels: ['Amazon Global', 'Amazon.in', 'Bazar.com', 'Wholesale Exports'],
    services: ['Handmade Brass & Wood Decor', 'Artisan Fair-Trade Sourcing', 'Custom Corporate Gifting'],
    icon: 'Palette',
  },
  {
    ...
    channels: ['B2B Corporate Travel', 'Retail Travel Counters', 'Online Booking Portal'],
    services: ['Custom Inbound/Outbound Packages', 'Corporate MICE & Conferences', 'Luxury Hotel & Flight Ticketing'],
    icon: 'Plane',
  },
  {
    id: 'delight-apparel',
    ...
    channels: ['Amazon.in', 'Amazon.com', 'Global Fashion Boutiques'],
    services: ['OEM Garment Manufacturing', 'Private Label Apparel', 'E-Commerce Fashion Distribution'],
    icon: 'Shirt',
  },
  {
    id: 'aap-ka-haq',
    ...
    channels: ['Direct Corporate Retainers', 'Digital Legal Advisory', 'Legal Clinics'],
    services: ['Export Contract Vetting', 'IP & Trademark Filing', 'Dispute Resolution & Advisory'],
    icon: 'Scale',
  },
  {
    id: 'bk-metal',
    ...
    channels: ['Industrial EPC Projects', 'Solar Farm Contractors', 'Direct B2B'],
    services: ['Solar Module Mounting Structures (MMS)', 'Hot-Dip Galvanizing', 'Custom CNC Steel Fabrication'],
    icon: 'Hammer',
  },
];
...
export const PRODUCTS_CATALOG: ProductItem[] = [
  // SOLAR PRODUCTS
  {
    ...
    packaging: ['27-31 modules per pallet', 'Heavy-duty export seaworthy crates', 'Full 40ft HQ Container loads'],
    applications: ['Utility-scale Solar Farms', 'Commercial & Industrial Rooftops', 'Residential Rooftops', 'Solar Microgrids'],
  ...
  // FMCG & AGRO PRODUCTS
  {
    ...
    packaging: ['1kg, 5kg, 10kg, 25kg, 50kg PP bags / Non-woven / Jute Bags / Custom Private Label'],
  ...
  },
  {
    ...
    packaging: ['100g, 250g, 500g nitrogen-flushed retail pouches; 10kg bulk master cartons'],
  ...
  },
  {
    ...
    packaging: ['25kg & 50kg PP bags with inner liner, customized retail spice tins'],
  ...
  },
  {
    ...
    packaging: ['20kg export cartons with dual poly-liner, 100g/250g retail canisters'],
  ...
  },
  {
    ...
    packaging: ['Multi-layer foil laminated barrier pouches for freshness retention'],
  ...
  },
  {
    ...
    packaging: ['50g, 100g, 250g airtight zipper pouches / glass jars'],
    imageUrl: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=800&auto=format&fit=crop&q=80',
  },
  {
    ...
    packaging: ['100g, 250g, 500g craft paper zipper pouches / 25kg fiber drums'],
  ...
  },
  {
    ...
    packaging: ['25kg multi-wall paper bags with HDPE inner liner'],
  ...
  },
  {
    ...
    packaging: ['500ml, 1 Litre glass jars, 5 Litre & 15kg food-grade tin containers'],
  ...
  },
  {
    ...
    packaging: ['5kg, 10kg, 25kg, 50kg moisture-resistant bags; palletized bulk'],
  ...
  // CRAFT & APPAREL
  {
    ...
    packaging: ['Individual thermo-cushioned gift box + Export Master Carton'],
  ...
  },
  {
    ...
    packaging: ['Individual polybag with barcode tag, standard assortment cartons'],
  ...
  // METAL STRUCTURES
  {
    ...
    packaging: ['Bundled with heavy-duty steel strapping, seaworthy container pack'],
